...
import com.liuzemin.server.framework.model.constant.EndType;
import com.liuzemin.server.framework.model.constant.WordType;
 ...
 * @author feng yi
 */
public class WordContext implements Serializable {
    private static final long serialVersionUID = -503270761544266743L;
    ...
    public WordContext(List<String> blackList, List<String> whiteList) {
